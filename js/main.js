...
<p><span class="tag f">Fact</span> Ordinary radiation (X-rays / “gamma”) goes through the body like a flashlight beam. Alpha radiation is more like a short, heavy punch — it dumps energy in a tiny neighborhood and stops. That is why DaRT is implanted <em>in</em> the tumor instead of beamed from outside.</p>
<p><span class="tag f">Fact</span> Their main US approval push is <b>ReSTART</b> for recurrent skin cancer (cSCC) — <a href="https://clinicaltrials.gov/study/NCT05323253" target="_blank" rel="noopener">NCT05323253</a>. <b>88 patients</b> enrolled, complete May 2026 (<a href="https://www.sec.gov/Archives/edgar/data/1871321/000121390026053589/ea028978301ex99-1.htm" target="_blank" rel="noopener">SEC 6-K</a>). Doctors will report how many tumors shrank (ORR) and whether responses lasted at least 6 months (DOR).</p>
<p><span class="tag f">Fact</span> Alpha DaRT is regulated as a <b>medical device</b> (PMA), not a pill or infusion (NDA). That changes how FDA reviews evidence — often against historical performance goals rather than a randomized drug-style control arm.</p>
...
<p><span class="tag f">Fact</span> Liquidity was ~$80.2M at Mar 31 2026 per the Q1 PR — runway depends on burn (~$10.6M/qtr derived from FY2025) and any Tolmar inflows. Share count (~42M ADS in the <a href="https://www.sec.gov/cgi-bin/viewer?accession_number=0001213900-26-025174&action=view&cik=1871321" target="_blank" rel="noopener">SEC 20-F</a>) matters for “per share” math — an F-3 shelf can dilute later, so treat $/share as a scenario, not a promise.</p>
...
<p><span class="tag u">Assumption</span> Valuation peak-sales and P(success) sliders are educational scenarios. Cash (~$80.2M Q1) and ~42M ADS from the <a href="https://www.sec.gov/cgi-bin/viewer?accession_number=0001213900-26-025174&action=view&cik=1871321" target="_blank" rel="noopener">20-F</a> set the per-share denominator — F-3 shelf capacity is not the same as shares outstanding today.</p>
...
<p><span class="tag f">Fact</span> ReSTART co-primaries are confirmed ORR (RECIST 1.1) and DOR at 6 months — <a href="https://clinicaltrials.gov/study/NCT05323253" target="_blank" rel="noopener">NCT05323253</a>. Single-arm design means success is framed against historical performance, not a concurrent control. Device PMA (modular, Breakthrough for recurrent cSCC) is a different regulatory lane than a drug NDA.</p>
<p><span class="tag f">Fact</span> Pipeline beyond skin: REGAIN rGBM feasibility (n≤10; interim n=3 local control) and IMPACT pancreatic pilot (target n=40, US responses not disclosed) are hypothesis-generating. Japan Shonin (selected H&amp;N, Feb 2026) is real approval but reimbursement and PMS still matter for commercial timing.</p>
<p><span class="tag m">Model</span> ReSTART ORR slider priors span ~45–65% (1σ) as undisclosed assumptions. Benchmark slider anchors cemiplimab 47% (◆) and literature floor 26–40%. Wilson 95% CI brackets binomial uncertainty at n=88. DOR is a pass/fail gate in this model, not a full survival curve.</p>
<p><span class="tag u">Assumption</span> Blue prior bands on sliders encode literature-backed plausibility; red hatch = hard to defend without data. Monte Carlo uses a seeded Beta prior (n=1500) so repeated visits get the same histogram. Valuation $/share divides risk-adjusted EV by share count — treat share count as an input that can change with ATM/shelf issuance.</p>
...
<p><span class="tag f">Fact</span> Mechanism: Ra-224-loaded seeds release α-emitting daughters that create a mm-scale dose cloud while individual α tracks remain ~40–70 μm (<a href="https://pubmed.ncbi.nlm.nih.gov/20463379/" target="_blank" rel="noopener">Arazi 2010</a>). High LET and reduced oxygen enhancement ratio vs photons motivate use in hypoxic solid tumors — see Biology sims for pedagogy, not MC dosimetry.</p>
...
<p><span class="tag m">Model</span> DOR modeled as pass/fail vs 6-month gate — not Kaplan–Meier. Combined P(PMA) = 55% structural ORR/DOR score + 45% subjective PMA prior slider. Modular PMA module 1 submitted Jan 2026 — timeline heuristic only (<a href="https://www.fda.gov/medical-devices/premarket-submissions/modular-premarket-approval-program" target="_blank" rel="noopener">FDA modular PMA</a>). PMA ≠ NDA: FDA device guidance emphasizes historical performance goals and single-arm bias risks.</p>
<p><span class="tag f">Fact</span> Pipeline caveats: REGAIN interim n=3 cannot support registrational inference; IMPACT US pilot responses undisclosed; Japan Shonin is indication-limited. Valuation peak ($M/yr) = patients/yr × pen × years × price ($K) ÷ 1,000; risk-adj EV sums indication contributions × P(success) + platform option.</p>
<p><span class="tag u">Assumption</span> Blue prior bands on sliders encode literature-backed plausibility; red hatch = hard to defend without data. Share links encode slider deltas plus preset markers (<code>rp</code>/<code>vp</code>) so bull/bear scenarios restore correctly across tabs. Per-share outputs use ~42M ADS and cash from the <a href="https://www.sec.gov/cgi-bin/viewer?accession_number=0001213900-26-025174&action=view&cik=1871321" target="_blank" rel="noopener">20-F</a> — F-3/ATM capacity can change the denominator.</p>
...
<p><span class="tag f">Fact</span> IMPACT pancreatic US pilot targets n=40 (<a href="https://www.alphatau.com/single-post/alpha-tau-announces-fda-approval-of-ide-supplement-to-expand-alpha-dart-impact-trial-to-patients-wi" target="_blank" rel="noopener">IDE supplement Apr 2026</a>) — no US response counts disclosed; pooled ASCO 2026 pancreatic OS data is a separate design and must not be mixed into IMPACT priors.</p>
<p><span class="tag m">Model</span> Valuation: peak ($M/yr) = patients/yr × pen × years × price ($K) ÷ 1,000; risk-adj EV = Σ (peak × EV multiple × P(success)) + platform. Cash default ~$80.2M (Q1 2026); ~42M ADS per <a href="https://www.sec.gov/cgi-bin/viewer?accession_number=0001213900-26-025174&action=view&cik=1871321" target="_blank" rel="noopener">SEC 20-F FY2025</a>. Tolmar: 60% net sales — <a href="https://www.sec.gov/Archives/edgar/data/1871321/000121390026064461/ea0293331-6k_alpha.htm" target="_blank" rel="noopener">SEC 6-K</a>. Indication P(success) defaults keep GBM/pancreas low relative to skin.</p>
...
<p>→ <a href="#alpha-sim-penetration" onclick="document.querySelector('.tabbtn[data-tab=biology]').click();return true;">Sim A: penetration</a> · <a href="#alpha-sim-bragg" onclick="document.querySelector('.tabbtn[data-tab=biology]').click();return true;">Sim B: LET</a> · <a href="#alpha-sim-hypoxia" onclick="document.querySelector('.tabbtn[data-tab=biology]').click();return true;">Sim D: hypoxia</a> on Biology tab.</p>`,
...
<p><span class="tag m">Model</span> MC: Beta(α,β) with α = p·20, β = (1−p)·20 — moderate prior strength. Success = observed ORR ≥ threshold AND one-sided binomial beat of p₀ at α=0.05 heuristic. Wilson CI used for display, not as primary test statistic. Combined P(PMA) blends structural ORR/DOR score with a subjective PMA prior — not a formal Bayesian decision analysis.</p>
